            ...
            <div className="container mx-auto px-6">
                <div className="mb-16 text-center">
                    ...
                    <p className="text-foreground/80 mx-auto max-w-2xl text-lg">
                        Have questions about our REST API? Reach out to us via email.
                    </p>
                </div>

                <div className="mx-auto max-w-2xl">
                    <div className="bg-card/30 border-border/30 rounded-2xl border p-8 text-center">
                        <div className="bg-primary/10 mx-auto mb-6 flex h-16 w-16 items-center justify-center rounded-full p-4">
